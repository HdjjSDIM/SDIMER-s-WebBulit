  ...
  ?>
                <div class="row">
                    <div class="leftcolumn">
                        ...
                        <div class="card">
                            ...
                            <?php if($current_user_permission==1){ ?>
                            <div>
              ...
              if(isset($_POST['comment_btn'])){
                ...
                if(!empty($artical_number) && !empty($content)&&!empty($comment_time)){
                  ...
                  foreach($comment as $comment1){
                    if($comment1['content']==$content&&$comment1['comment_writerid']==$current_user_id){
                      $cannot_comment=1;
                    }
                  }
                  if($cannot_comment==0){
          ...
          foreach($comment as $comment){
            if($comment['artical_id']==$showing_artical['uid']){ ?>
                            ...
                            <?php if($current_user_permission==0){ ?>
                            <div class="card">
                                <h1>请登录以解锁点赞、收藏、评论功能</h1>
                            </div>
                            <?php }?>
