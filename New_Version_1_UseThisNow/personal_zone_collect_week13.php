  ...
  <!-- <div class="leftcolumn">
    <div class="card">
      ...
      <div class="artical_information">
        ...
        <input type="button" class="button_1" style="margin-left:  5px" value="取消收藏">

        <h4>　摘要：　<span style="font-family:'宋体';">　这里写摘要
            我想知道这里面的字体大于一行的时候它的排版我想知道这里面的字体大于一行的时候它的排版我想知道这里面的字体大于一行的时候它的排版我想知道这里面的字体大于一行的时候它的排版 <span
              style="color: #FD3134">右边操作栏会往下退，所以摘要字数要在100字以内</span></span></h4>
      </div>
